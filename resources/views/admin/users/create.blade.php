               ...
               <form class="form-horizontal" action="{{route('admin.users.store')}}" method="POST" >
                   ...
                   <div class="card-body">
                       <div class="form-group">
                           ...
                           <input type="text" name="name" class="form-control" id="inputName" placeholder="نام کاربر را وارد کنید">
                       </div>
                       <div class="form-group">
                   ...
                   <div class="card-footer">
                       <button type="submit" class="btn btn-outline-warning text-bold text-dark">ثبت کاربر</button>
