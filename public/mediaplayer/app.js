...
//
// const forwardBtn = document.querySelector('i.bi-skip-forward-circle');
// const backwardBtn = document.querySelector('i.bi-skip-backward-circle');
// const playBtn = document.querySelector('i.bi-play-circle');
// const pauseBtn = document.querySelector('i.bi-pause-circle');
